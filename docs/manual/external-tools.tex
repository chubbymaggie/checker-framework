...
\item If your code uses annotations in comments, make Gradle use the Type Annotations compiler:
...
dependencies {
  ...
  // Choose the first line if targeting Java 7, the second line otherwise.
...
\item If your code does not use annotations in comments, use this:
...
\item
  If you wish to use a locally-built version of the Checker Framework,
  rather than one from Maven Central, then replace the \<dependencies>
  section above by this one:
